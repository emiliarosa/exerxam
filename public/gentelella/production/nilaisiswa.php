...
<html lang="en">
  <head>
    ...
    <title>Hasil Nilai Siswa | Exerxam</title>
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="#" class="btn btn-primary btn-xs"><i class="fa fa-folder" id="fc_create" data-toggle="modal" data-target="#CalenderModalNew01"></i> View </a>
                          </td>
                        </tr>
                        <tr>
                          <td>2</td>
        ...
        <!-- /footer content -->
        <div id="CalenderModalNew01" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
