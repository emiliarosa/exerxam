...
<html lang="en">
  <head>
    ...
    <title>Bobot Soal | Exarxam</title>
    <!-- Bootstrap -->
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>5</td>
                          <td>Medium</td>
                          <td><a button="submit" class="btn btn-primary btn-xs" id="fc_create" data-toggle="modal"data-target="#CalenderModalNew7"><i class="fa fa-folder" ></i> Bobot </a></td>
                        </tr>  
                      </tbody>
                    </table>
                  </div>
        ...
        <!-- /footer content -->
    <div id="CalenderModalNew7" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
