...
<table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td>Dibawah ini peryataan yang salah mengenai lingkungan hidup adalah...</td>
                          <td>3</td>
                          <td>Lingkungan hidup tidak memiliki produsen dan konsumen</td>
                          <td><button type="submit">update<button type="submit">del</button></td>
                        </tr>
                      </tbody>
                    </table>
                </form>
